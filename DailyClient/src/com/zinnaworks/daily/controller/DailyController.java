...
public class DailyController implements OnButtonListener {
	...
	public void action(ActionEvent e) {
		if (e.getActionCommand() == "insert") {
			...
			threadManager.executeThread(new PoolDailyService(Const.DB_COMMAND_INSERT,type,tarea,new DailyVO(userUI.getNameText().getText(),
					userUI.getEmailText().getText(), userUI.getDetailText().getText(), userUI.getAgeText().getText())));
		} else if (e.getActionCommand() == "delete") {
			threadManager.executeThread(new PoolDailyService(Const.DB_COMMAND_DELETE,type,tarea,new DailyVO(userUI.getNameText().getText(),
					userUI.getEmailText().getText(), userUI.getDetailText().getText(), userUI.getAgeText().getText())));
			System.out.println("delete click");
		} else if (e.getActionCommand() == "update") {
			threadManager.executeThread(new PoolDailyService(Const.DB_COMMAND_UPDATE,type,tarea,new DailyVO(userUI.getNameText().getText(),
					userUI.getEmailText().getText(), userUI.getDetailText().getText(), userUI.getAgeText().getText())));
			System.out.println("update click");
		} else if (e.getActionCommand() == "search") {
			threadManager.executeThread(new PoolDailyService(Const.DB_COMMAND_SEARCH,type,tarea,new DailyVO(userUI.getNameText().getText(),
					userUI.getEmailText().getText(), userUI.getDetailText().getText(), userUI.getAgeText().getText())));
			System.out.println("search click");
		} else if (e.getActionCommand() == "list") {
			threadManager.executeThread(new PoolDailyService(Const.DB_COMMAND_LIST,type,tarea,new DailyVO(userUI.getNameText().getText(),
					userUI.getEmailText().getText(), userUI.getDetailText().getText(), userUI.getAgeText().getText())));
